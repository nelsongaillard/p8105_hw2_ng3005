...
In the tidy dataset `zip_zori_df`, there are a total of `r nrow(zip_zori_df)` observations. There are `r n_distinct(zip_zori_df$zip_code)` unique zip codes and `r n_distinct(zip_zori_df$neighborhood)`
...
From the newly generated table, the neighborhood with the greatest rent drop between January 2020 and January 2021 was Lower Manhattan with a rent drop of over $912. 
